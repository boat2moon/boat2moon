    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-50">
      ...
      >
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-6 sm:px-10 lg:px-16">
          ...
          <section id="projects" className="space-y-8">
            <div className="space-y-2">
              <h2 className="text-2xl font-semibold">主要项目案例</h2>
              <p className="text-sm text-zinc-500">精选项目展示从调研、架构到交付的闭环能力。</p>
            </div>
            <div className="grid gap-6 md:grid-cols-2">
              {projects.map((project) => (
                <Card key={project.title} className="border border-zinc-200 bg-white/85 shadow-sm">
                  <CardHeader>
          ...
          <section id="fullstack" className="space-y-8">
            <div className="space-y-2">
              <h2 className="text-2xl font-semibold">全栈技术</h2>
              <p className="text-sm text-zinc-500">核心技术支柱，覆盖研发链路的关键节点。</p>
            </div>
            <div className="grid gap-6 md:grid-cols-2">
              {fullStackFocus.map((topic) => (
                <Card key={topic.title} className="border border-zinc-200 bg-white/85 shadow-sm">
                  <CardHeader>
          ...
          <section id="omni" className="space-y-8">
            <div className="space-y-2">
              <h2 className="text-2xl font-semibold">全端开发</h2>
              <p className="text-sm text-zinc-500">多端协同交付的知识图谱。</p>
            </div>
            <div className="grid gap-6 md:grid-cols-3">
              {omniDeliveries.map((item) => (
                <Card key={item.title} className="border border-zinc-200 bg-white/80 shadow-sm">
                  <CardHeader>
                    <CardTitle className="text-lg">{item.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
          ...
          <section id="business" className="space-y-8">
            <div className="space-y-2">
              <h2 className="text-2xl font-semibold">业务赋能</h2>
              <p className="text-sm text-zinc-500">聚焦“如何创造可衡量的业务价值”。</p>
            </div>
            <div className="grid gap-6 md:grid-cols-3">
              {businessEmpowerment.map((item) => (
                <Card key={item.title} className="border border-zinc-200 bg-white/80 shadow-sm">
          ...
          <section
            id="notes"
            className="rounded-3xl border border-zinc-200 bg-white/85 p-10 shadow-sm"
          >
            <h2 className="text-2xl font-semibold">杂记</h2>
